...
###from Pointnet_Pointnet2_pytorch/visualizer/show3d_balls.py
import numpy as np
import ctypes as ct
import cv2
import sys
...
if __name__ == '__main__':
    ...
    xyz = np.random.rand(100, 3) * 10  # 100个点，每个点的坐标在 [0, 10) 范围内
    color = np.random.randint(0, 256, size=(100, 3))  # 100个点，每个点的颜色为随机值
    showpoints(xyz, c_gt=color)
